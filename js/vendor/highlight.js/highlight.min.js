...
}function Q(e,n){function t(e){return e.replace(/&(amp|lt|gt|quot|#x27);/g,((e,n)=>({amp:"&",lt:"<",gt:">",quot:"\"","#x27":"'"}[n]||e)))}e.replaceChildren();const a=document.createDocumentFragment(),i=[a];let r=0;for(;r<n.length;){const s=n.indexOf("<",r);if(-1===s){n.slice(r)&&i[i.length-1].appendChild(document.createTextNode(t(n.slice(r))));break}s>r&&i[i.length-1].appendChild(document.createTextNode(t(n.slice(r,s))));if(n.startsWith("</span>",s)){i.length>1&&i.pop(),r=s+7;continue}if(n.startsWith('<span class="',s)){const e=s+13,t=n.indexOf('">',e);if(-1!==t){const a=n.slice(e,t);if(/^[A-Za-z0-9_ -]+$/.test(a)){const e=document.createElement("span");e.className=a,i[i.length-1].appendChild(e),i.push(e),r=t+2;continue}}}i[i.length-1].appendChild(document.createTextNode("<")),r=s+1}e.appendChild(a)}function a(e,...n){const t=Object.create(null);for(const n in e)t[n]=e[n]
...
;Q(e,r.value),e.dataset.highlighted="yes",((e,n,t)=>{const a=n&&i[n]||t
